...
//     resolved?: boolean;
//     unreplied?: boolean;
//     mainPost?: posts.PostObject;
//     index?:number;
//     scheduled?:boolean;
//     create?: (data: TopicObject) => Promise<number>;
//     post?: Promise<{
...
//     Topics.create = async function (data:TopicObject) {
...
//         let postData: posts.PostObject = data;
//         postData.tid = tid;
...
//         }
//         const topicData: TopicObject = topics[0];
